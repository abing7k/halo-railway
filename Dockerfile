...
CMD [ "--spring.config.location=classpath:/application.yaml,file:./application.yaml" ,"--halo.security.initializer.superadminusername=admin",  "--halo.security.initializer.superadminpassword=alex@123"]